...
public class KVMetricNames {
    ...
    public static final String TRANSACTIONOP             = "transaction_operation";
    public static final String READONLYOP                = "read_only_operation";
    public static final String MERGE                     = "merge_operation";
    public static final String SPLIT                     = "split_operation";
    public static final String ENTRYSIZE                 = "entry_operation";
}
