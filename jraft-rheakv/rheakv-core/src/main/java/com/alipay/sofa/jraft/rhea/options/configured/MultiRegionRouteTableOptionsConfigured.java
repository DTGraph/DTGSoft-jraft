...
public final class MultiRegionRouteTableOptionsConfigured implements Configured<List<RegionRouteTableOptions>> {
    ...
    public MultiRegionRouteTableOptionsConfigured withInitNodeStartId(final Long regionId, final long startId) {
        getOrCreateOptsById(regionId).setInitNodeId(startId);
        return this;
    }

    public MultiRegionRouteTableOptionsConfigured withInitRelationStartId(final Long regionId, final long startId) {
        getOrCreateOptsById(regionId).setInitRelationId(startId);
        return this;
    }
