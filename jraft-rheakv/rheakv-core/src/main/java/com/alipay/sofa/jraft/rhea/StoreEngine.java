...
>>>>>>> first commit
    ...
    public synchronized boolean init(final StoreEngineOptions opts) {
        ...
        for (final RegionEngineOptions rOpts : rOptsList) {
            ...
            System.out.println("PD group id is : " + JRaftHelper.getJRaftGroupId(clusterName, rOpts.getRegionId()));
    ...
    protected boolean initRawKVStore(final StoreEngineOptions opts) {
    ...
    protected boolean initAllRegionEngine(final StoreEngineOptions opts, final Store store) {
