...
public class Region implements Copiable<Region>, Serializable {
    ...
    private byte[]            nodeStartId;
    private byte[]            nodeEndId;
    private byte[]            relationStartId;
    private byte[]            relationEndId;
    private byte[]            temporalPropertyStartId;
    private byte[]            temporalPropertyEndId;
    ...
    public Region(long id, byte[] nodeStartId, byte[] nodeEndId, byte[] relationStartId, byte[] relationEndId,
    ...
    public Region copy() {
        ...
        return new Region(this.id, this.nodeStartId, this.nodeEndId, this.relationStartId, this.relationEndId,
            this.temporalPropertyStartId, this.temporalPropertyEndId, regionEpoch, peers);
    }
    ...
    public String toString() {
        return "Region{" + "id=" + id + ", nodeStartId=" + BytesUtil.toHex(nodeStartId) + ", nodeEndId="
               + BytesUtil.toHex(nodeEndId) + ", relationStartId=" + BytesUtil.toHex(relationStartId)
               + ", relationEndId=" + BytesUtil.toHex(relationEndId) + ", temporalPropertyStartId="
               + BytesUtil.toHex(temporalPropertyStartId) + ", temporalPropertyEndId="
               + BytesUtil.toHex(temporalPropertyEndId) + ", regionEpoch=" + regionEpoch + ", peers=" + peers + '}';
    }
}
